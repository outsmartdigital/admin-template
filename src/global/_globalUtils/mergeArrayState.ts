...
import { GlobalEntityState, GlobalEntityStateKeys, InitialGlobalEntityState } from '../InitialGlobalState'
...
export const mergeArrayEntityState = <ArrayType, Type extends Partial<GlobalEntityStateKeys>>(
